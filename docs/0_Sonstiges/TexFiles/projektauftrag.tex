...
\begin{tabularx}{\textwidth}{|l|X|}
	...
	\hline
	\colorcelllight{} & Marius Tuschl 40d \\
	\cline{2-2}
	\colorcelllight{} & Markus Bauer 20d\\
	\cline{2-2}
	\colorcelllight{} & Richard Tscharntke 20d\\
	\cline{2-2}
	\multirow{-4}{*}{\colorcelllight{Personalkosten}} & Patrick Gruber 20d\\
	\hline
	\colorcelllight{Summe Pers.Kosten} & 80.000\euro\\
	\hline
	\colorcelllight{} & Beratungskosten  200\euro pro Stunde.\\
	\cline{2-2}
	\multirow{-2}{*}{\colorcelllight{Ausgabewirksame Kosten}} &Miete Büro 20.000\euro.\\
	\hline
	\colorcelllight{Sonstige Ressourcen} & Server für Datenbank und Services\\
	\hline
	\colorcelllight{Projekbudget} & 150.000\euro\\
	\hline
	\colorcelllight{Wirtschaftlichkeit} & Nach der Beendigung des Projekt kann mit Einnahmen über das Schalten von Werbung gerechnet werden.\\
	\hline
	\colorcelllight{Folgekosten} & Es ist mit keinen besonderen Folgekosten zu rechnen. \\
	\hline
\end{tabularx}
\newline
\vspace{2pt}
...
\begin{tabularx}{\textwidth}{|l|X|X|X|X|}
	...
	\hline
	\colorcelllight{strategische Bedeutung} & &\checkmark & &\\
	\cline{2-5}
	\colorcelllight{Risikogehalt} & & & &\checkmark \\
	\cline{2-5}
	\colorcelllight{Komplexitätsgrad} &\checkmark & & & \\
	\cline{2-5}
	\colorcelllight{Neuartigskeitsgrad} & & & &\checkmark \\
	\cline{2-5}
	\colorcelllight{Termindurck} & & &\checkmark& \\
	\cline{2-5}
	\colorcelllight{Klarheit über Projektziele} & & \checkmark& & \\
	\hline
\end{tabularx}
\newline
\vspace{2pt}
